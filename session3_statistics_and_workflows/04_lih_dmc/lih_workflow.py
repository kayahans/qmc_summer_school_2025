...
qmc = generate_qmcpack(
    ...
    seed          = 42,       # Fix the seed (lab only)
    qmc           = 'dmc',    # DMC run
    total_walkers = 1024,     # DMC walker population sampled from VMC
    vmc_blocks    = 200,      
    vmc_steps     = 20,
    vmc_timestep  = 0.3,
...
qmc = generate_qmcpack(
    ...
    seed            = 42,       # Fix the seed (lab only)
    qmc             = 'dmc',    # DMC run
    total_walkers   = 1024,     # Initial DMC population from VMC
    vmc_blocks      = 200,
    vmc_steps       = 20,
    vmc_timestep    = 0.3,
...
qmc = generate_qmcpack(
    ...
    vmc_steps     = 20,
    vmc_timestep  = 0.3,
    total_walkers = 256,      # Except with smaller population
    eq_dmc        = True,     
    eq_blocks     = 30,
    eq_steps      = 10,
    eq_timestep   = 0.02,
